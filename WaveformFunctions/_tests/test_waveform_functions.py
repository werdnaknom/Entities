...
class WaveformFunctionsTestCase(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.location = r"test_files/CH2.bin"
    ...
    def test_read_waveform_binary_compressed(self):
        from Helpers.waveform_functions import read_waveform_binary
    ...
    def test_read_waveform_binary_uncompressed(self):
        ...
        self.assertAlmostEqual(wf[-1], 3.34, places=2)

    def test_create_waveform_x_coords(self):
        from Helpers.waveform_functions import create_waveform_x_coords
    ...
    def test_min_max_downsample_2d(self):
        from Helpers.waveform_functions import min_max_downsample_2d
        from Helpers.waveform_functions import create_waveform_x_coords
        from Helpers.waveform_functions import read_waveform_binary
        x_inc = 0.00000008
        length = 1250000
    ...
    def test_min_max_downsample_1d(self):
        from Helpers.waveform_functions import min_max_downsample_1d
        from Helpers.waveform_functions import read_waveform_binary
        size = 500
    ...
    def test_find_cutoff_target_by_percentile(self):
        from Helpers.waveform_functions import find_cutoff_target_by_percentile
        from Helpers.waveform_functions import read_waveform_binary
    ...
    def test_find_steady_state_wf(self):
        from Helpers.waveform_functions import find_steady_state_wf
        from Helpers.waveform_functions import read_waveform_binary
    ...
    def test_steady_state_waveform_by_percentile(self):
        from Helpers.waveform_functions import find_steady_state_waveform_by_percentile
        from Helpers.waveform_functions import read_waveform_binary
